...
export const MANUAL_TICKER_ITEMS: ManualTickerItem[] = [
  ...
  { kind: 'score', text: 'Last Week \u00B7 Week 1: SEA 35  NE 13 \u00B7 FINAL', href: 'https://youtu.be/MGRyb41Y__M?si=gagntaCHJgP1mnUS' },
  { kind: 'score', text: 'This Week \u00B7 Week 2: SEA 35  AZ 21 \u00B7 FINAL', href: 'https://youtu.be/y6jK9GHGN1c?si=1yFEgxAtDJ2UnGcn' },

  // ---- NOTES (your voice — jokes, status, asides) --------------------------
  { kind: 'note', text: 'Next Week \u00B7 Week 3: SEA vs. WAS ' },
